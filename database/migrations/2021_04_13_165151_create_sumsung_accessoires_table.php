...
class CreateSumsungAccessoiresTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sumsung_accessoires', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('sumsung_accessoires');
    }
}
